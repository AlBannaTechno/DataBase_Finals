...
"connect to database"
db = MySQLDatabase('TESTDB', user='root',passwd='',host="localhost")
#db = MySQLDatabase('TESTDB', user='root',passwd='')# localhost is default
...
Bookse.create_table()
"now we will insert values into Bookse table "
